  ...
  return (
    <AppBarStyled position="sticky" color="default">
      <ToolbarStyled>
        ...
        <Box ml={2}>
          {role === "superAdmin" ? (
            <Typography color='#31363F' fontWeight={"bold"} variant="h5">Super Admin Panel</Typography>
          ) : (
            <Typography color='#31363F' fontWeight={"bold"} variant="h5">User Panel</Typography>
          )}
        </Box>
